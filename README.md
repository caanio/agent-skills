...
| [python-coding-standards](skills/python-coding-standards/SKILL.md) | Personal Python defaults: type hints, no globals, `logging` over `print()`, wrapping any I/O in try/except, testing real behaviour, where design docs go |
