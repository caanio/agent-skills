...
| [git-helper](skills/git-helper/SKILL.md) | Git commit workflow: confirm staging → secrets + PII scan → generate commit messages meeting Conventional Commits + Chris Beams standards |
